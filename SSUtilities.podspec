...
Pod::Spec.new do |spec|
  ...
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  spec.source       = { :git => "https://github.com/ndson040496/SSUtilitiesiOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "SSUtilities", "SSUtilities/**/*.{swift}"
  spec.public_header_files = "SSUtilities/**/SSUtilities.h"
